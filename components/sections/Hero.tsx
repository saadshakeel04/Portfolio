    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-16 w-full">
        ...
        <motion.button
          ...
          className="hidden md:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-2 text-muted-foreground hover:text-cyan-400 transition-colors z-20"
